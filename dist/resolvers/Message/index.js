...
let MessageResolver = class MessageResolver {
    ...
    async getMessages(chatId, cursor, limit, { req }) {
        ...
        const messages = await (0, typeorm_1.getConnection)().query(`
      SELECT m.*
...
__decorate([
    (0, type_graphql_1.Subscription)(() => Message_1.Message, {
...
__decorate([
    ...
    __param(1, (0, type_graphql_1.Arg)("chatId", () => type_graphql_1.Int)),
...
__decorate([
    (0, type_graphql_1.UseMiddleware)(isAuth_1.isAuth),
    (0, type_graphql_1.Query)(() => PaginatedMessages, { nullable: true }),
