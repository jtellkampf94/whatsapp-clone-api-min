...
__decorate([
    type_graphql_1.Field({ nullable: true }),
    typeorm_1.Column({ default: "Hi there! I am using WhatsApp." }),
    __metadata("design:type", String)
...
__decorate([
    type_graphql_1.Field(() => [Chat_1.Chat], { nullable: true }),
    __metadata("design:type", Array)
], User.prototype, "chats", void 0);
__decorate([
    typeorm_1.OneToMany(() => ChatMember_1.ChatMember, (chatMember) => chatMember.user),
    __metadata("design:type", Array)
